...
Curl:
	...
	.\curl.exe -v -H "Accept: application/json" -H "Content-Type: application/json" -X PUT -d $json http://localhost:2235/v1/rallyresults/update/event/id/3
	
	.\curl.exe -v -H "Accept: application/json" -H "Content-Type: application/json" -X DELETE http://localhost:2235/v1/rallyresults/delete/event/id/3
